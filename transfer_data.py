...
class Transfer_Data:
    ...
    def __init__(self, size=2000):
        ...
        self.conn_target, self.cur_target = connect_mysql.conn_mysql(host=mysql_config["sit_208"]["host"],
                                             port=mysql_config["sit_208"]["port"],
                                             user=mysql_config["sit_208"]["user"],
                                             password=mysql_config["sit_208"]["password"],
                                             database=mysql_config["sit_208"]["database"],
                                             charset=mysql_config["sit_208"]["charset"])
